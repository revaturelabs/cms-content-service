<<<<<<< Updated upstream:src/test/java/com/revature/services/SearchServiceTest.java
...
public class SearchServiceTest {
	...
	// }
>>>>>>> Stashed changes:src/test/java/com/revature/servicestests/SearchServiceTest.java
}