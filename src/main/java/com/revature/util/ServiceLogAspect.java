...
public class ServiceLogAspect {// Logging aspect that has a list of logs for various functions that are run
	...
	public void logContentService_createContent(JoinPoint jp) {
		log.info(jp.getSignature().getName() + " has successfully created a content");
	}
	...
	public void logContentService_getAllContent(JoinPoint jp) {
		log.info(jp.getSignature().getName() + " has successfully retrieved all contents");
	}
	...
	public void logContentService_getContentById(JoinPoint jp) {
		log.info(jp.getSignature().getName() + " has successfully retrieved a content");
	}
	...
	public void logSearchService_filterContentByTitle(JoinPoint jp) {
		log.info(jp.getSignature().getName() + " has successfully filtered a content by title");
	}
	...
	public void logSearchService_filterContentByFormat(JoinPoint jp) {
		log.info(jp.getSignature().getName() + " has successfully filtered a content by format");
	}
	...
	public void logSearchService_filterContentBySubjects(JoinPoint jp) {
		log.info(jp.getSignature().getName() + " has successfully filtered a content by subsject");
	}
	...
	public void logSearchService_getContentByModuleId(JoinPoint jp) {
		log.info(jp.getSignature().getName() + " has successfully retrieved a content by module ID");
	}
	...
	public void logSearchService_filter(JoinPoint jp) {
		log.info(jp.getSignature().getName() + " has successfully filtered a content");
	}
	...
	public void logModuleService_getAllModules(JoinPoint jp) {
		log.info(jp.getSignature().getName() + " has successfully retrieved all the modules");
	}
	...
	public void logModuleService_getModuleById(JoinPoint jp) {
		log.info(jp.getSignature().getName() + " has successfully retrieved a module by ID");
	}
	...
	public void logModuleService_createModule(JoinPoint jp) {
		log.info(jp.getSignature().getName() + " has successfully created a module");
	}
}
