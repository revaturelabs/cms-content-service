...
public class JSONContent {
	...
	public JSONContent(int id, String title, String format, String description, String url, long dateCreated,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		JSONContent other = (JSONContent) obj;
	...
	public String toString() {
		return "JSONContent [id=" + id + ", title=" + title + ", format=" + format + ", description=" + description
